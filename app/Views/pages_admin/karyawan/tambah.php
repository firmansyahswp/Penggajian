    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                <div class="card-body">
                    <form class="needs-validation" method="POST" action="<?= base_url('admin/karyawan/store') ?>" enctype="multipart/form-data" novalidate>
                        <?= csrf_field() ?>
                        <div class="row">
                            ...
                            <div class="col-md-9 border-right pr-4">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="nip" id="nip" class="form-control <?= service('validation')->hasError('nip') ? 'is-invalid' : '' ?>" value="<?= old('nip') ?>" required>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="nm_karyawan" id="nm_karyawan" class="form-control <?= service('validation')->hasError('nm_karyawan') ? 'is-invalid' : '' ?>" value="<?= old('nm_karyawan') ?>" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="alamat" id="alamat" class="form-control <?= service('validation')->hasError('alamat') ? 'is-invalid' : '' ?>" rows="2"><?= old('alamat') ?></textarea>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <?php $selected_kelamin = old('kelamin'); ?>
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" name="agama" id="agama" class="form-control <?= service('validation')->hasError('agama') ? 'is-invalid' : '' ?>" value="<?= old('agama') ?>">
                                        <div class="invalid-feedback"><?= service('validation')->showError('agama') ?></div>
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="no_telp">Nomor Telepon</label>
                                        <input type="text" name="no_telp" id="no_telp" class="form-control <?= service('validation')->hasError('no_telp') ? 'is-invalid' : '' ?>" value="<?= old('no_telp') ?>">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="tempat_lahir" id="tempat_lahir" class="form-control <?= service('validation')->hasError('tempat_lahir') ? 'is-invalid' : '' ?>" value="<?= old('tempat_lahir') ?>">
                                        <div class="invalid-feedback"><?= service('validation')->showError('tempat_lahir') ?></div>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="tgl_lahir">Tanggal Lahir</label>
                                        <input type="date" name="tgl_lahir" id="tgl_lahir" class="form-control <?= service('validation')->hasError('tgl_lahir') ? 'is-invalid' : '' ?>" value="<?= old('tgl_lahir') ?>">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <?php $selected_jabatan = old('kd_jabatan'); ?>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="date" name="tanggal_masuk" id="tanggal_masuk" class="form-control <?= service('validation')->hasError('tanggal_masuk') ? 'is-invalid' : '' ?>" value="<?= old('tanggal_masuk') ?>" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <?php $selected_lokasi = old('id_lokasi_default'); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <?php $selected_kawin = old('status_kawin'); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="jumlah_anak" id="jumlah_anak" class="form-control <?= service('validation')->hasError('jumlah_anak') ? 'is-invalid' : '' ?>" value="<?= old('jumlah_anak', 0) ?>">
                                    <div class="invalid-feedback"><?= service('validation')->showError('jumlah_anak') ?></div>
                                </div>

                                <div class="form-group">
                                    <label for="id_ptkp">Status PTKP</label>
                                    <?php $selected_ptkp = old('id_ptkp'); ?>
                                ...
                                <h5 class="text-primary mb-3 mt-4 pb-2 border-bottom"><i class="fas fa-lock"></i> Akun Pengguna (Wajib)</h5>
                                
                                <div class="form-group">
                                    <label for="username">Username <span class="text-danger">*</span></label>
                                    <input type="text" name="username" id="username" class="form-control <?= service('validation')->hasError('username') ? 'is-invalid' : '' ?>" value="<?= old('username') ?>" placeholder="Default: NIP" required>
                                    <div class="invalid-feedback"><?= service('validation')->showError('username') ?: 'Username wajib diisi.' ?></div>
                                </div>
                                
                                <div class="form-group">
                                    <label for="level">Level Akses <span class="text-danger">*</span></label>
                                    <?php $selected_level = old('level', 'Pegawai'); ?>
                                    <select name="level" id="level" class="form-control <?= service('validation')->hasError('level') ? 'is-invalid' : '' ?>" required>
                                        ...
                                        <option value="Manajer" <?= $selected_level == 'Manajer' ? 'selected' : '' ?>>Manajer</option>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" name="password" id="password" class="form-control <?= service('validation')->hasError('password') ? 'is-invalid' : '' ?>" placeholder="Wajib diisi" required>
                                    <div class="invalid-feedback"><?= service('validation')->showError('password') ?: 'Password wajib diisi.' ?></div>
                                </div>
...
<script>
    // Script ini meniru skrip AdminLTE/Bootstrap standard untuk form validation

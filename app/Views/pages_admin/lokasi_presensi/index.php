        ...
        <div class="container-fluid">
            ...
            <?php if (session()->getFlashdata('pesan')): ?>
                <div class="alert alert-success alert-dismissible fade show" role="alert">
                    ...
                    <!-- Menggunakan tombol bootstrap 5 untuk dismiss -->
            ...
            <div class="card shadow mb-4">
                <div class="card-body">
                    <div class="table-responsive">
                        <!-- Perhatikan variabel yang dilempar dari Controller: $lokasi_presensi -->
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                <!-- Loop menggunakan variabel $lokasi_presensi -->
                                <?php $no=1; foreach($lokasi_presensi as $lokasi) : ?>
                                    <tr>
                                        ...
                                        <!-- Menampilkan Radius -->
                                        <td class="text-center"><?= number_format($lokasi['radius'], 0, ',', '.')?></td>
                                        
                                        <!-- Menampilkan Zona Waktu -->
                                        <td class="text-center"><?= $lokasi['zona_waktu'] ?></td>

                                        <!-- Menampilkan Jam Masuk dan Pulang -->
                                        <td class="text-center"><?= $lokasi['jam_masuk'] ?> - <?= $lokasi['jam_pulang'] ?></td>
                                        
                                        <td>
                                            <center>
                                                <!-- Link Edit ke Controller LokasiPresensi dengan ID -->
                                                <a class="btn btn-sm btn-info" href="<?= base_url('admin/lokasipresensi/edit/'.$lokasi['id']) ?>"><i class="fas fa-edit"></i></a>
                                                
                                                <!-- Tombol Delete dengan data-id yang disesuaikan -->

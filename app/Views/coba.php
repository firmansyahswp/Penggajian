...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/svg+xml" href="./assets1/favicon-CvUZKS4z.svg">
    <link rel="icon" type="image/png" href="./assets1/favicon-B_cwPWBd.png">
    ...
    <!-- PWA Manifest -->
    <link rel="manifest" href="./assets1/manifest-DTaoG9pG.json">
  <script type="module" crossorigin src="./assets1/main-f0Mg-34g.js"></script>
  <link rel="stylesheet" crossorigin href="./assets1/main-DLfE7m78.css">
</head>

        ...
        <div class="container-fluid">
            ...
            <div class="card shadow">
                <div class="card-header">
                    <h3 class="card-title">Edit Pengajuan #<?= $izin['id'] ?></h3>
                </div>
                ...
                <form action="<?= base_url('pegawai/ketidakhadiran/update/' . $izin['id']) ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <p class="text-danger">Hanya pengajuan berstatus PENDING yang dapat diubah.</p>
                        ...
                        <div class="form-group">
                            ...
                            <select name="keterangan" id="keterangan" class="form-control" required>
                                <option value="Izin" <?= old('keterangan', $izin['keterangan']) === 'Izin' ? 'selected' : '' ?>>Izin</option>
                                <option value="Sakit" <?= old('keterangan', $izin['keterangan']) === 'Sakit' ? 'selected' : '' ?>>Sakit</option>
                            </select>
                        </div>
                        
                        <div class="form-group">
                            <label for="deskripsi">Deskripsi:</label>
                            <textarea name="deskripsi" id="deskripsi" class="form-control" rows="4" required><?= old('deskripsi', $izin['deskripsi']) ?></textarea>
                        </div>
                        
                        <div class="form-group">
                            <label for="file_bukti">File Bukti (Kosongkan jika tidak diubah):</label>
                            <input type="file" name="file_bukti" id="file_bukti" class="form-control-file">
                            <?php if ($izin['file']): ?>
